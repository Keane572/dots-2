...
editor = "nvim" -- os.getenv("EDITOR") or "vim"
...
globalkeys = gears.table.join(
	...
	end, { description = "open a app-launcher", group = "launcher" }),
	awful.key({}, "XF86AudioRaise", function()
		awful.spawn("kitty -e amixer sset Master 5%+")
	end, { description = "increase volume", group = "audio" }),
	awful.key({ modkey }, "XF86AudioLower", function()
		awful.spawn("kitty -e amixer sset Master 5%-")
	end, { description = "lower volume", group = "audio" }),
	awful.key({ modkey }, "XF86AudioMute", function()
		awful.spawn("kitty -e amixer sset Master toggle")
